  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      <div className="mx-auto max-w-4xl px-4 py-10 sm:px-6">
        ...
        {reportId && (
          <div className="mt-4 inline-flex items-center gap-1.5 rounded-md bg-slate-100 px-3 py-1.5 text-xs text-muted-foreground">
        ...
        {topic && (
          <div className="mt-6 rounded-2xl border border-indigo-200 bg-primary/10/60 p-5">
            {/* 标题栏 */}
            <div className="flex items-center gap-2 text-indigo-700">
              {analyzing ? (
                ...
                <>
                  ...
                  {analysis.themeLabel && (
                    <span className="ml-1 rounded-full bg-card px-2 py-0.5 text-[11px] font-medium text-primary shadow-sm">
                      {analysis.themeLabel}
                    </span>
                  )}
                </>
                  ...
                  {dynamicQuestions.map((q, qi) => (
                    <div key={q.id}>
                      ...
                      <div className={`mb-2 flex items-center gap-2 ${qi > 0 ? "ml-4 border-l-2 border-indigo-200 pl-3" : ""}`}>
                        <div className="text-sm font-medium text-muted-foreground">{q.q}</div>
                        {qi > 0 && (
                          ...
                          return (
                            <button
                              ...
                              className={`rounded-full border px-3 py-1.5 text-xs font-medium transition-all ${
                                on
                                  ? "border-indigo-500 bg-primary/100 text-white shadow-sm"
        ...
        {/* 生成表单（始终可见可填） */}
        <div className="mt-8 grid grid-cols-1 gap-5 rounded-2xl border border-border bg-card p-5 shadow-sm md:grid-cols-2">
          <div className="md:col-span-2">
            ...
            <textarea
              ...
              className="w-full resize-none rounded-lg border border-border px-3 py-2 text-sm text-slate-800 outline-none focus:border-primary"
            />
          </div>
          <div className="md:col-span-2">
            <label className="mb-1.5 block text-sm font-medium text-muted-foreground">
            ...
            <input
              ...
              className="w-full rounded-lg border border-border px-3 py-2 text-sm text-slate-800 outline-none focus:border-primary"
            />
          </div>
          <div>
            <label className="mb-1.5 block text-sm font-medium text-muted-foreground">类型</label>
            <select
              value={type}
          ...
          <div>
            <label className="mb-1.5 block text-sm font-medium text-muted-foreground">创作风格（来自你的档案）</label>
            <select
              value={style}
          ...
          <div>
            <label className="mb-1.5 block text-sm font-medium text-muted-foreground">目标受众（来自你的档案）</label>
            <select
              value={audience}
        ...
        {/* 合规声明 */}
        <div className="mt-4 flex items-start gap-2 rounded-lg border border-border bg-muted/40 px-4 py-3 text-xs leading-relaxed text-muted-foreground">
        ...
        {result && (
          <div className="mt-6 rounded-2xl border border-border bg-card p-5 shadow-sm">
            <div className="flex items-center justify-between">
              ...
              <button
                onClick={handleCopy}
                className="inline-flex items-center gap-1 rounded-md border border-border px-2.5 py-1.5 text-xs font-medium text-muted-foreground hover:bg-muted/40"
              >
            ...
            <pre className="mt-4 whitespace-pre-wrap rounded-lg bg-muted/40 p-3 text-xs leading-relaxed text-muted-foreground">
              {result.full}
            </pre>
