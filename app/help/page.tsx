...
const FAQS: { q: string; a: string }[] = [
  {
    q: "怎么分析一个视频？",
    a: "进入「AI 分析」页，上传本地 MP4，或粘贴抖音 / 小红书等平台视频链接。系统会解析内容并生成报告：爆款评分、为什么火、结构拆解、可复制模板、拍摄建议，以及开头吸引力 / 标题优化 / 选题推荐等高级模块。",
  },
  {
    q: "免费版和会员有什么区别？",
    a: "免费版：每天 1 次分析、基础版报告（评分 + 核心亮点）、浏览案例库。普通会员：无限次分析、完整版报告、三大高级模块、模板一键生成、优先排队、记录云同步与 PDF 导出。高级会员：再上账号诊断、每日选题推荐、内容规划助手、数据看板、专属客服与团队席位。完整对比见「价格」页。",
  },
  {
    q: "微信登录安全吗？我的数据存在哪？",
  ...
  {
    q: "报告里的「高级模块」是什么？为什么免费看不了？",
    a: "高级模块指：开头吸引力深度分析、标题优化器 · A/B、选题推荐（按你的方向）。它们属于会员专属能力，免费会员在报告里会被锁定并提示升级；升级后即可查看真实内容。",
  },
  {
    q: "分析报告是 AI 真实生成的吗？",
